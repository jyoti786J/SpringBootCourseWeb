...
mary	marypw	TEACHER	Course management
...
- DAO & DTO Patterns for clean data architecture
- H2 Database with file-based persistence
- JSP with Fragments for reusable UI components
- Batch File Upload for efficient resource management
